...
<section class="mx-auto max-w-3xl">
	...
	<div class="mt-8 mb-8 sm:mt-10">
		...
		<h1 class="text-3xl font-bold tracking-tight sm:text-4xl">Create a new competition</h1>
	</div>

	<form method="POST" class="rounded-3xl border border-white/10 bg-white/3 p-5 sm:p-6">
		{#if form?.error}
		...
		<div class="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
			<a
				...
				class="rounded-full border border-white/15 px-5 py-3 text-center font-medium text-white transition hover:bg-white/10"
			>
				Cancel
			</a>
